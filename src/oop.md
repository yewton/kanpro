...
description: 〈完全なプログラミング〉を目指す会 2026 オブジェクト指向プログラミング編です
---
...
# <!--fit--> とはいえ<br> **OOP 一辺倒ではない**

---

-   複雑さと戦う道具は OOP だけではない
-   **イミュータブル / 関数型** : 状態を持たなければ、追うべき状態も無い
-   **`record` / `data class`** : 値オブジェクトを短く・安全に
-   **Rust の所有権** : 共有と可変を型で縛り、バグを未然に防ぐ
...
-   どれも **複雑さを人間が扱えるサイズに収める** ための道具
-   状態・可変・共有を **減らす／局所化する** ほど、読み手(人間も AI も)の負荷は下がる
-   **道具を選ぶ目を持とう** 。OOP もその一つ

...
/--- エドガー・W・ダイクストラ [[http://www.unixuser.org/~euske/doc/dijkstra-ja/thehumbleprogrammer.html][謙虚なるプログラマ (The Humble Programmer)]]/
#+end_quote

{{{img(bg left,2020-03-25_03-36-32_edsger-dijkstra-e1528238724590.jpg)}}}
...
#+begin_src plantuml :eval never-export :file assets/java_collection.png :cmdline -charset UTF-8
  scale 2
...
{{{img(bg right contain,java_collection.png)}}}

* {{{fit}}} =kotlin.collections.ArrayList=

#+begin_src plantuml :eval never-export :file assets/kotlin_collection.png :cmdline -charset UTF-8
  scale 2
  hide empty member
...
{{{img(bg right contain,kotlin_collection.png)}}}

{{{newpage}}}

{{{img(bg contain,java_collection.png)}}}
{{{img(bg contain,kotlin_collection.png)}}}
...
#+begin_src plantuml :eval never-export :file assets/traditional_layer.png :cmdline -charset UTF-8
  scale 2
  hide members
  hide circles
...
{{{img(,traditional_layer.png)}}}


* 依存関係を逆転

#+begin_src plantuml :eval never-export :file assets/dip_layer.png :cmdline -charset UTF-8
  scale 1.5
  hide members
  hide class circles
...
- [[https://shop.nikkeibp.co.jp/front/commodity/0000/589000/][日経BP SHOP｜Code Complete 第2版 上 － 完全なプログラミングを目指して]]
- [[https://shop.nikkeibp.co.jp/front/commodity/0000/589100/][日経BP SHOP｜Code Complete 第2版 下 － 完全なプログラミングを目指して]]
- [[https://shop.nikkeibp.co.jp/front/commodity/0000/P84650/][オブジェクト指向でなぜつくるのか第2版 知っておきたいOOP、設計、関数型言語の基礎知識]]
- [[https://www.pearson.com/us/higher-education/program/Martin-Clean-Architecture-A-Craftsman-s-Guide-to-Software-Structure-and-Design/PGM333762.html][Martin, Clean Architecture: A Craftsman's Guide to Software Structure and Design | Pearson]]
...
- [[https://www.irasutoya.com/2016/07/blog-post_864.html][インターネットの神様のイラスト | かわいいフリー素材集 いらすとや]]
- [[https://plantuml.com/ja/][Open-source tool that uses simple textual descriptions to draw beautiful UML diagrams.]]

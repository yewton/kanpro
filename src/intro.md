...
基本的には [CODE COMPLETE 第2版](https://amzn.to/2R9TvN7) を題材に、
...
-   [CODE COMPLETE 第2版](https://amzn.to/2R9TvN7) の日本語訳のサブタイトルが **完全なプログラミングを目指して**
...
![bg right contain](assets/larry.jpg)


# 〈完全〉を求めるのは<br>勤勉だからでも<br>完璧主義者だからでもない
...
-   これまで言ってきたのは組織内でビジネスロジックをチーム開発で実装するという文脈の話
-   関わる人が一人しかいないとか、全員が同じスキルレベルで人の出入りもない、とかなら、
    **「とりあえず動けばいい」が一番はやいかも** しれない
-   **最速** を目指してください
-   組織でチーム開発するならこれまで言って来たことがきっと役に立ちます
